...
public class ExplodedArchiveTests {
	...
	public void getEntries() {
		Map<String, Entry> entries = getEntriesMap(this.archive);
	...
	public void getNonRecursiveEntriesForRoot() {
		...
		Map<String, Entry> entries = getEntriesMap(archive);
	...
	private Map<String, Entry> getEntriesMap(Archive archive) {
